...
if (isset($_COOKIE['msdn']) && $_COOKIE['msdn'] != "" && $_COOKIE['loaiuser'] >= 98) { ?>
    ...
    <div id="content" style="background-color: #e0e0e0;">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h5 mb-2 text-gray-800" style="text-align: center; margin: 10px 0px; padding-bottom: 7px; border-bottom: solid 1px #d1d1d1;">CẬP NHẬT PHIẾU NHẬP</h1>
                            ...
                            <div class="col-5">
                                ...
                                <div class="filter_date" style="margin-top: 0;">
                                    ...
                                    <div data-target="#form_add_ncc" data-toggle="modal">
                                        <img style="width: 30px ;height: 30px;" src="./vendor/img/add.png">
                                    </div>
                                </div>
                            </div>
                            <div class="col-2">
                    ...
                    <div class="nhapkho">
                        <div class="form_chitiethoadon " style="padding: 10px; display: flex;">
                            ...
                            <label for="dvt_add">
                                ...
                                <select class="select_add" style="width: 200px;" id="dvt_add">
                                    <?php
                                    foreach ($list_dvt as $r) {
                                        echo '<option value="' . $r->tenloai . '" data-msloai="' . $r->msloai . '">' . $r->tenloai . '</option>';
                                    }
                                    ?>
                                </select>
                            </label>
                        ...
                        <div class="form_chitiethoadon " style="padding: 10px;display: flex; align-items: end; gap: 20px;">
                            ...
                            <label for="vat_add">
                                ...
                                <input id="vat_add" onkeyup="tinh_gianhapcothue()" class="input_add" style="color:#000;width: 100px;" value="5">
                            </label>
        ...
        <div class="modal-dialog modal_dialog_xetnghiem" style="max-width:430px">
            <div class="modal-content">
                ...
                <div class="modal-body" style="display:flex;justify-content: center; flex-direction: column; align-items: center;">
                    <img style="width: 50px;height: 50px;" src="./vendor/img/check_128.png">
                    <h5 style="color:green; margin-top: 10px;">Cập nhật kho thành công</h5>
                </div>
