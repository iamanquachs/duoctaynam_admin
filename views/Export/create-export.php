...
if (isset($_COOKIE['msdn']) && $_COOKIE['msdn'] != "" && $_COOKIE['loaiuser'] >= 98) { ?>
    ...
    <div id="content" style="background-color: #e0e0e0;">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h5 mb-2 text-gray-800" style="text-align: center; margin: 10px 0px; padding-bottom: 7px; border-bottom: solid 1px #d1d1d1;">TẠO PHIẾU <span style="text-transform: uppercase;" id='title_loai_xuat'></span></h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="row input_right">
                                    ...
                                    <input id='thanhtoan_add' class="form_input_right_add  col-6" style="text-align: end;" type="text" value="0">
                                </div>
                            </div>
                            <div class="col-4" style="display:flex; gap:10px;justify-content: end;">
                                <a onclick="huy_xuatkho_export()" id="huy_xuatkho">
    ...
    <!-- Form chưa chọn loại xuất  -->
    <div class="modal fade" id="form_chuachon_loaixuat" data-bs-backdrop="static" data-keyboard="false" aria-labelledby="form_add" aria-hidden="true">
        <div class="modal-dialog modal_dialog_xetnghiem" style="max-width:430px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 style="color:red">Vui lòng chọn loại xuất</h5>
                </div>
