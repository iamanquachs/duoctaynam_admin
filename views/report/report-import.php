    ...
    <div id="content" style="background-color: #e0e0e0;">
        ...
        <div class="container-fluid">
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                <h1 class="h5 mb-2 text-gray-800" style="text-align: center; margin: 10px 0px; padding-bottom: 7px; ">Chi tiết nhập kho</h1>
                ...
                <div class="col-12 ">
                    <div class="nhapkho">
                        <div style="display: flex; justify-content: space-between; align-items: center ;">
                            <input id="valueSearch" style="border:none;border-bottom: 1px solid #ddd; width: 350px;" onkeyup="load_report_import()" value="" placeholder="Tìm Tên NCC, MSNCC, Tên HH, MSHH, Số CT">
                            <div style="display: flex;  border-radius: 5px; background-color: #e4fae9;">
                                <div id="datepicker_tungay" class="input-group date datepicker_donhang" data-date-format="dd/mm/yyyy">
                                    ...
                                    <input style="background-color: #e4fae9; color: #000; border: none" id="tungay" onchange="load_report_import()" class="form-control donhang_tungay" placeholder="Từ ngày" value="<?= date('d/m/Y', strtotime('0 day', strtotime(date('Y-m-d')))); ?>" type="text"> <span class="input-group-addon"></span>
                                ...
                                <div id="datepicker_denngay" class="input-group date datepicker_donhang" data-date-format="dd/mm/yyyy">
                                    ...
                                    <input style="background-color: #e4fae9; color: #000; border: none;" id="denngay" onchange="load_report_import()" class="form-control donhang_denngay" placeholder="Đến Ngày" name="denngay" value="<?= date('d/m/Y'); ?>" type="text"> <span class="input-group-addon"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 20px; max-height: 600px; overflow-y: scroll;">
                            <table class="table table-bordered table-gre">
                                ...
                                <tbody class="__chitiet_report_import">
