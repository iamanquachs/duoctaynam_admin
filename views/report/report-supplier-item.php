    ...
    <div id="content" style="background-color: #e0e0e0;">
        ...
        <div class="container-fluid">
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                <h1 class="h5 mb-2 text-gray-800" style="text-align: center; margin: 10px 0px; padding-bottom: 7px; ">Nhà cung cấp -  sản phẩm</h1>
                    ...
                    <div class="nhapkho">
                        <div style="display: flex; justify-content: space-between; align-items: center ;">
                            <div style="display: flex; justify-content: space-between; align-items: end ; gap:20px">
                                <select name="" id="loaiSearch" onchange="show_search(this)" class="form-control" style="max-width: 150px;">
                                    <option selected value='tenncc'>Tên NCC</option>
                                    <option value='msncc'>MS NCC</option>
                                    <option value='soct'>Số CT</option>
                                </select>
                                <input id="valueSearch" style="border:none;border-bottom: 1px solid #ddd; width: 350px;" onkeyup="load_report_supplier_item()" value="" placeholder="Tìm Tên NCC, MS NCC, Số CT">
                            </div>
                            ...
                            <div style="display: flex;  border-radius: 5px; background-color: #e4fae9;">
                                <div id="datepicker_tungay" class="input-group date datepicker_donhang" data-date-format="dd/mm/yyyy">
                                    ...
                                    <input style="background-color: #e4fae9; color: #000; border: none" id="tungay" onchange="load_report_supplier_item()" class="form-control donhang_tungay" placeholder="Từ ngày" value="<?= date('d/m/Y', strtotime('0 day', strtotime(date('Y-m-d')))); ?>" type="text"> <span class="input-group-addon"></span>
                                ...
                                <div id="datepicker_denngay" class="input-group date datepicker_donhang" data-date-format="dd/mm/yyyy">
                                    ...
                                    <input style="background-color: #e4fae9; color: #000; border: none;" id="denngay" onchange="load_report_supplier_item()" class="form-control donhang_denngay" placeholder="Đến Ngày" name="denngay" value="<?= date('d/m/Y'); ?>" type="text"> <span class="input-group-addon"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 20px; max-height: 600px; overflow-y: scroll;">
                            <table class="table table-bordered table-gre">
                                ...
                                <tbody class="__chitiet_report_supplier_item">
